 ...
 */
package im.yangqiang.android.unicorn.data.database;
...
import im.yangqiang.android.unicorn.data.database.entity.DaoConfig;
import im.yangqiang.android.unicorn.data.database.inf.IDBUpdateListener;
import im.yangqiang.android.unicorn.data.database.sqlite.CursorUtils;
import im.yangqiang.android.unicorn.data.database.sqlite.DBModel;
import im.yangqiang.android.unicorn.data.database.sqlite.ManyToOneLazyLoader;
import im.yangqiang.android.unicorn.data.database.sqlite.OneToManyLazyLoader;
import im.yangqiang.android.unicorn.data.database.sqlite.SqlBuilder;
import im.yangqiang.android.unicorn.data.database.sqlite.SqlInfo;
import im.yangqiang.android.unicorn.data.database.table.KeyValue;
...
public class UinSqliteDB
{
    ...
    private void insertContentValues(List<KeyValue> list, ContentValues cv)
    {
        ...
        {
            ULog.w(TAG, "insertContentValues: List<KeyValue> is empty or ContentValues is empty!");
        }
    ...
    private void exeSqlInfo(SqlInfo sqlInfo)
    {
        ...
        {
            ULog.e(TAG, "sava error:sqlInfo is null");
        }
    }
